...
--2
SELECT * FROM clientes_fieis(1, '2025-06-01', '2025-06-30');
--3
SELECT * FROM pedidos_acima_da_media();
...
INSERT INTO CONTA_RECEBER (
  id_pedido, data_vencimento, valor, data_pagamento, status_pagamento, id_forma_pagamento
)
VALUES (
  1, '2025-07-01', 100.00, '2025-06-25', 'PAGO', 1
);
